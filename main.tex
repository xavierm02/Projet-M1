...
\subsection{Un bilan de cette construction}
	Nous cherchons \`a diagnostiquer un langage fautif dans un syst\`eme S.
...
\subsubsection{Exemples des syst\`eme opaque et non-opaque}
		\begin{figure}[H]
                \centering
                \begin{tikzpicture}
