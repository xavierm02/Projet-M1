...
\begin{itemize}
	...
	\item Orwellian : $k_i = \lambda$ qui modélise un observateur omniscient avec une mémoire infinie.
	\item m-orwellian : $k_i = l_{max(1,i-m+1)} \dots l_{min(n,i+m-1)}$ qui modélise un observateur qui connaît le passé proche et le futur proche.
\end{itemize}
