...
\usepackage{tikz}
\usepackage{float}
\newtheorem{mydef}{D\'efinition}[subsection]
\newtheorem{myth}{Th\'eor\`eme}[subsection]
...
\begin{myth}
Tout probl\`eme de non-interf\'erence peut se r\'eduire \`a un probl\`eme d'opacit\'e reposant sur une fonction 'dobservation statique.
\end{myth}
\section{Conclusion}
