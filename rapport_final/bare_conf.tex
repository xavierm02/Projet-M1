...
Ce syst\`eme sans la fl\`eche $b$  de $O$ vers $S$ est T-diagnosticable. Si on ajoute cette fl\`eche $b$, ce n'est plus T-diagnosticable. Consid\'erons les deux ex\'ecutions suivantes:
