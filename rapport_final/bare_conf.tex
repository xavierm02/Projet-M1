...
Prenons un example de T-diagnosticabilit\'e :
...
La construction du T-diagnostiqueur consiste seulement à d\'eterminiser l'automate $S$. Pour utiliser ce T-diagnostiqueur sur une séquence d'évènements, on lit le mot correspondant avec le déterminisé et quand on arrive dans un \'etat qui correspond uniquement à des \'etats $\Box$, on peut lever une alarme pour indiquer qu'il y a eu une faute.
